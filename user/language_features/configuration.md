...
## General
Configuration properties set here will be available to the test execution as environment variables. Please see [Managing Environments](#..\advanced_readings\managing_environments) for more details.
